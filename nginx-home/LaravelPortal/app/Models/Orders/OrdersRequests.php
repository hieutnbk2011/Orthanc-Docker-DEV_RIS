...
/**
     ...
     */
    protected $casts = [
        'priority' => 'string', 'active' => 'boolean', 'patient_fname' => 'string', 'patient_lname' => 'string', 'patient_mname' => 'string', 'patient_birth_date' => 'date', 'patient_sex' => 'string', 'patientid' => 'string', 'patient_email' => 'string', 'patient_phone_ctry' => 'string', 'patient_phone' => 'string', 'referring_physician_id' => 'string', 'referring_physician_fname' => 'string', 'referring_physician_lname' => 'string', 'referring_physician_phone_ctry' => 'string', 'referring_physician_phone' => 'string', 'referring_physician_email' => 'string', 'provider_type_text' => 'string', 'indication' => 'string', 'orderedbyuser_id' => 'int', 'orderbyuser_name' => 'string', 'timestamp' => 'datetime', 'scheduled_procedure_step_start_date' => 'date', 'requested_procedure_id' => 'string', 'related_employment' => 'string', 'related_auto' => 'string', 'related_otheraccident' => 'string', 'related_emergency' => 'string', 'related_drugs' => 'string', 'related_pregnancy' => 'date', 'employed' => 'string', 'employed_student' => 'string', 'employed_other' => 'string', 'illness_date' => 'date'
    ];
